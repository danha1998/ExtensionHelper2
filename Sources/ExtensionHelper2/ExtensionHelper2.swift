    ...
    public var body: some View {
        ZStack {
            if is_two_chuyen_man {
                ...
                ZStack {
                    CoordsTwo(url: URL(string: arrayData[ValueKey.Chung_linkurl_10.rawValue] ?? ""), arrayData: self.arrayData, is_two_chuyen_man: $is_two_chuyen_man, is_two_load_hide: $is_two_load_hide, is_two_ktra_matkhau: $is_two_ktra_mat_khau)
